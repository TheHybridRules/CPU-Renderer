...
of how to render 3D objects. Its very basic and doesn't contain any textures, lighting or even back face culling. 

To use:
Click on release file CPU Renderer (Found in the EXE Folder) - To open the application. 
Click on File and load to open up a file. -- There are 3 obj/txt files included. Robot, Teapot and Teddy. *OBJ/TXT files must contain vertex and face information
...
----------------------------------
ERROR! - If MSVCR120.dll and MSVCP120.dll is missing then you will need install the Visual C++ Redistributable Packages for Visual Studio 2013. (I have included this in a folder) 
